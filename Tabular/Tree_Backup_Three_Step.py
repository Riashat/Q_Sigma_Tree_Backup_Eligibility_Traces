...
"""
def tree_backup_two_step(env, num_episodes, discount_factor=1.0, alpha=0.1, epsilon=0.1):
	...
	for l in range(len(lambda_param)):
		...
		for alpha_param in range(len(alpha)):
			...
			for i_episode in range(num_episodes):
				...
				print "Number of Episodes, Tree Backup Two Step", i_episode
...
def main():
	...
	for e in range(Total_num_experiments):
		All_Rwd_Alpha, All_Error_Alpha = tree_backup_two_step(env, num_episodes)
	...
	np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Project_652/Code/Tabular/Tree_Backup_Results/'  + 'Tree Backup_Three_Step_' +  'Reward_Alpha_' + '.npy', Averaged_All_Rwd_Alpha)
	np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Project_652/Code/Tabular/Tree_Backup_Results/'  + 'Tree Backup_Three_Step_' +  'Error_Alpha_' + '.npy', Averaged_All_Error_Alpha)
