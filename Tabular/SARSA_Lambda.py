...
SARSA(Lambda)
"""
def sarsa_lambda(env, num_episodes, discount_factor=1.0, alpha=0.1, epsilon=0.1):
...
def main():
	...
	for e in range(Total_num_experiments):
		All_Rwd_Lambda, All_Lambda_Alpha, All_Error_Lambda, All_Error_Lambda_Alpha = sarsa_lambda(env, num_episodes)
	...
	np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Project_652/Code/Tabular/Sarsa_Lambda_Results/'  + 'Sarsa(lambda)_' +  'Reward_Lambda_' + '.npy', Averaged_All_Rwd_Lambda)
	np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Project_652/Code/Tabular/Sarsa_Lambda_Results/'  + 'Sarsa(lambda)_' +  'Lambda_Alpha' + '.npy', Averaged_All_Lambda_Alpha)
	np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Project_652/Code/Tabular/Sarsa_Lambda_Results/'  + 'Sarsa(lambda)_' +  'Error_Lambda_' + '.npy', Averaged_All_Error_Lambda)
	np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Project_652/Code/Tabular/Sarsa_Lambda_Results/'  + 'Sarsa(lambda)_' +  'Error_Lambda_Alpha' + '.npy', Averaged_All_Error_Lambda_Alpha)
