...
Watkins Q(lambda)
"""
def q_lambda_watkins(env, num_episodes, discount_factor=1.0, alpha=0.1, epsilon=0.1):
				...
				for t in itertools.count():
					...
					for s in range(env.observation_space.n):
						for a in range(env.action_space.n):
							...
							eligibility[s][a] = eligibility[s][a] * discount_factor * lambda_param[l]
...
def main():
	...
	for e in range(Total_num_experiments):
		All_Rwd_Lambda, All_Lambda_Alpha, All_Error_Lambda, All_Error_Lambda_Alpha = q_lambda_watkins(env, num_episodes)
	...
	np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Project_652/Code/Tabular/Q_Lambda_Watkins_Results/'  + 'Q(lambda)_' +  'Reward_Lambda_' + '.npy', Averaged_All_Rwd_Lambda)
	np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Project_652/Code/Tabular/Q_Lambda_Watkins_Results/'  + 'Q(lambda)_' +  'Lambda_Alpha' + '.npy', Averaged_All_Lambda_Alpha)
	np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Project_652/Code/Tabular/Q_Lambda_Watkins_Results/'  + 'Q(lambda)_' +  'Error_Lambda_' + '.npy', Averaged_All_Error_Lambda)
	np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Project_652/Code/Tabular/Q_Lambda_Watkins_Results/'  + 'Q(lambda)_' +  'Error_Lambda_Alpha' + '.npy', Averaged_All_Error_Lambda_Alpha)
