...
def Q_Sigma_Lambda_Off_Policy_Epsilon_Dependent(env, theta, num_episodes, discount_factor=1.0, epsilon=0.1, epsilon_decay=0.999, alpha=0.4, lambda_param=0.8):
...
def take_average_results(experiment,num_experiments,num_episodes,env,theta):
	...
	for i in range(num_experiments):
		...
		np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Project_652/Code/Linear_Approximator/Exploration_Dependent_Sigma/Results/'  + 'Q_Sigma_Lambda_Off_Policy_Epsilon_Dependent_Cum_Rwd' + '.npy', average_reward)
		np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Project_652/Code/Linear_Approximator/Exploration_Dependent_Sigma/Results/'  + 'Q_Sigma_Lambda_Off_Policy_Epsilon_Dependent_Cum_Err' + '.npy', average_error)
