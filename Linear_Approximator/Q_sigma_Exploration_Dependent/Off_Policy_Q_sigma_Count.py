...
def take_average_results(experiment,num_experiments,num_episodes,env,theta):
	...
	for i in range(num_experiments):
		...
		np.save('/home/raihan/Desktop/Final_Project_Codes/Windy_GridWorld/Experimental_Results /exploration_based_sigma/'  + 'Qsigma_offpolicy_reward' + '.npy',average_reward)
		np.save('/home/raihan/Desktop/Final_Project_Codes/Windy_GridWorld/Experimental_Results /exploration_based_sigma/'  + 'Qsigma_offpolicy_error' + '.npy',average_error)
