...
def tree_backup_lambda(env, theta, num_episodes, discount_factor=1.0, epsilon=0.1, epsilon_decay=1.0, alpha=0.5, lambda_param=0.1):
	...
	for i_episode in range(num_episodes):
		...
		print "Episode Number, Tree Backup (lambda):", i_episode
		...
		for t in itertools.count():
			...
			theta[:, action] += alpha * eligibility[:, action] * Delta
...
def main():
	...
	stats_sarsa_tb_lambda, cumulative_errors = tree_backup_lambda(env, theta, num_episodes)
	...
	np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Project_652/Code/Linear_Approximator/Eligibility_Traces/Accumulating_Traces/WindyGrid_Results/'  + 'Tree_Backup_RBF_Cum_Rwd_2' + '.npy', cum_rwd)
	np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Project_652/Code/Linear_Approximator/Eligibility_Traces/Accumulating_Traces/WindyGrid_Results/'  + 'Tree_Backup_RBF_Cum_Err_2' + '.npy', cum_err)
