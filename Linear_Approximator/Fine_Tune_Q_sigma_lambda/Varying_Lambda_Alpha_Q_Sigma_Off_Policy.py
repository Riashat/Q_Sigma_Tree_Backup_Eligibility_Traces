...
def q_sigma_lambda_off_policy_dynamic_sigma(env, theta, num_episodes, alpha, lambda_param,discount_factor=1.0, epsilon=0.1, epsilon_decay=.099):
...
def main():
	...
	for i in range(len(lambda_initialised)):
		for j in range(len(alpha_initialised)):
			...
			stats,cum_error=q_sigma_lambda_off_policy_dynamic_sigma(env,theta,num_episodes,alpha,lambda_param)
			...
			np.save('/home/raihan/Desktop/Final_Project_Codes/Windy_GridWorld/Experimental_Results /finetuning/'  + 'QsigmaLambdaOffPolicy_countbased_lambda_alpha_reward' + '.npy',lambda_alpha_reward)
			np.save('/home/raihan/Desktop/Final_Project_Codes/Windy_GridWorld/Experimental_Results /finetuning/'  + 'QsigmaLambdaOffPolicy_countbased_lambda_alpha_reward' + '.npy',lambda_alpha_error)
